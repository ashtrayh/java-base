...
public class GameXO extends JFrame {
    ...
    boolean isFull() {
        ...
        int reply = JOptionPane.showConfirmDialog(null, "Начать заново?", "Игра окончена", JOptionPane.YES_NO_OPTION);
        ...
        for (int i = 0; i < SIZE; i++) {
            ...
            for (int j = 0; j < SIZE; j++) {
                if (buttons[i][j].getText().equals("X")) {
                    countXH += 1;
                    if (countXH == SIZE) {
                        int reply = JOptionPane.showConfirmDialog(null, "Вы выиграли! Начать заново?", "Игра окончена", JOptionPane.YES_NO_OPTION);
                        if (reply == JOptionPane.YES_OPTION){
                            startNew();
                        } else {
                            System.exit(0);
                ...
                if (buttons[i][j].getText().equals("O")) {
                    countOH += 1;
                    if (countOH == SIZE) {
                        int reply = JOptionPane.showConfirmDialog(null, "Вы проиграли! Начать заново?", "Игра окончена", JOptionPane.YES_NO_OPTION);
                        if (reply == JOptionPane.YES_OPTION){
                            startNew();
                        } else {
                            System.exit(0);
